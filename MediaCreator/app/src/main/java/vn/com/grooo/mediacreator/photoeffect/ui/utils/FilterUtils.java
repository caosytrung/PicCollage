package vn.com.grooo.mediacreator.photoeffect.ui.utils;
...
public class FilterUtils {public static final String EFFECT_CONFIGS[] = {
        "",
    ...
    public static List<FilterObject> getFilterObject(){
        List<FilterObject> filterObjectList = new ArrayList<>();
        filterObjectList.add(new FilterObject("Original",0));
        filterObjectList.add(new FilterObject("Smooth",18));
        filterObjectList.add(new FilterObject("Dense",35));
        filterObjectList.add(new FilterObject("Golde",36));
        filterObjectList.add(new FilterObject("Brigh",38));
        filterObjectList.add(new FilterObject("Cherry",40));
        filterObjectList.add(new FilterObject("Magic",41));
        filterObjectList.add(new FilterObject("Cool",44));
        filterObjectList.add(new FilterObject("Sweet",45));
        filterObjectList.add(new FilterObject("GreeDa",63));
        filterObjectList.add(new FilterObject("Sea",65));
        filterObjectList.add(new FilterObject("OlsSt",93));
        filterObjectList.add(new FilterObject("Trans",10));
        filterObjectList.add(new FilterObject("Parag",13));
        filterObjectList.add(new FilterObject("Brig",23));
        filterObjectList.add(new FilterObject("Red",26));
        filterObjectList.add(new FilterObject("Green",27));
        filterObjectList.add(new FilterObject("Yellw",31));
